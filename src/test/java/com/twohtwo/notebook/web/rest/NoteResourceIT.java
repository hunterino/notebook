...
import com.twohtwo.notebook.repository.NoteRepository;
...
class NoteResourceIT {
    ...
    public static Note createEntity(EntityManager em) {
        Note note = new Note().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).date(DEFAULT_DATE);
        return note;
    }
    ...
    public static Note createUpdatedEntity(EntityManager em) {
        Note note = new Note().title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
        return note;
    }
    ...
    void putExistingNote() throws Exception {
        ...
        updatedNote.title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
    ...
    void partialUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.title(UPDATED_TITLE);
    ...
    void fullUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE);
