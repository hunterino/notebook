...
import { getEntity, deleteEntity } from './share.reducer';
...
export const ShareDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="notebookApp.share.delete.question">
        <Translate contentKey="notebookApp.share.delete.question" interpolate={{ id: shareEntity.id }}>
