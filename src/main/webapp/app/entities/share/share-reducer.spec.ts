...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './share.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHARE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHARE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHARE actions', async () => {
      const expectedActions = [
        {
