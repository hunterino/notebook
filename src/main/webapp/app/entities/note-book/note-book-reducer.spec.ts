...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './note-book.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTEBOOK_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTEBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTEBOOK actions', async () => {
      const expectedActions = [
        {
